...
#                              sheet = "stream", 
#                              range = "A1:AT1476") 
# SLPall <- read.csv(file.path(here::here("data/NewDataFromIrena20210130/New MAR Data/Raw Data Files/SLP/updatedSLPchem20210701")),
#                    "SleepersRiverAqueousChemistry.csv")
...
SLPall <- read.csv("data/NewDataFromIrena20210130/New MAR Data/Raw Data Files/SLP/updatedSLPchem20210701/SleepersRiverAqueousChemistry.csv") %>% 
...
# just one, no instance with two labs on the same date
SLPall %>% 
...
# mostly looking to see what changes with flow
ggpairs(SLPall %>% 
          select(W9_Flow_cfs, Ca.ueq.L, DOC.mg.L, NH4.ueq.L, NO3.ueq.L, PO4.mg.P.L, SO4.ueq.L) %>% 
          mutate(W9_Flow_cfs = log10(W9_Flow_cfs+10), 
                 Ca.ueq.L = log10(Ca.ueq.L + 10), 
                 DOC.mg.L = log10(DOC.mg.L + 10), 
                 NH4.ueq.L = log10(NH4.ueq.L + 10), 
                 NO3.ueq.L = log10(NO3.ueq.L + 10), 
                 PO4.mg.P.L = log10(PO4.mg.P.L + 10), 
                 SO4.ueq.L = log10(SO4.ueq.L + 10)))
