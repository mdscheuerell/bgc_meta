...
MEF_Q <- read.csv(file.path(here::here("01_data"), 
...
MEFin <- read.csv(here("01_data", 
                       "2022.03.04_S2LaggPool_ToHarmsT.csv")) %>%                 
                      select(Site, NAME, Date = DATE.TIME, 
...
MEF_chem <-  readxl::read_xlsx(file.path(here::here("01_data"), 
                                         "MEF raw data.xlsx"),
                               range = "A5:J1879",
...
# export df & save ----
write_csv(MEF.f, file.path(here::here("03_generatedData/"), "01_MEFcomb.csv"))
