...
SEF_1980_1999 <- read_csv(file.path(here::here("01_data"), 
...
SEFchem_1976_1994 <- read_csv(file.path(here::here("01_data"), 
...
# This has DOC
SEFchem_2004_2017 <- read_csv(file.path(here::here("01_data"), 
...
# EXPORT DATAFRAME ----
write_csv(SEF_final, file.path(here::here("03_generatedData/"), "01_SEFcomb.csv"))
