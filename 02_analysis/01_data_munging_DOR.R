...
DOR_Q <-  readxl::read_xlsx(file.path(here::here("01_data"), 
...
DOR_chem_HP3 <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
DOR_chem_HP3A <- readxl::read_xlsx(file.path(here::here("01_data"), 
                                            "DOR stream chemistry - compiled by Creed.xlsx"),
                                  sheet = "HP3A raw",
                                  range = "A2:G12055",
                                  col_names = DOR_chem_names)  %>% 
...
DOR_chem_HP4 <- readxl::read_xlsx(file.path(here::here("01_data"), 
                                             "DOR stream chemistry - compiled by Creed.xlsx"),
                                   sheet = "HP4 raw",
                                   range = "A2:G12055",
                                   col_names = DOR_chem_names)  %>% 
...
DOR_chem_HP5 <- readxl::read_xlsx(file.path(here::here("01_data"), 
                                            "DOR stream chemistry - compiled by Creed.xlsx"),
                                  sheet = "HP5 raw",
                                  range = "A2:G12055",
                                  col_names = DOR_chem_names)  %>% 
...
DOR_chem_HP6 <- readxl::read_xlsx(file.path(here::here("01_data"), 
                                            "DOR stream chemistry - compiled by Creed.xlsx"),
                                  sheet = "HP6 raw",
                                  range = "A2:G12055",
                                  col_names = DOR_chem_names)  %>% 
...
DOR_chem_HP6A <- readxl::read_xlsx(file.path(here::here("01_data"), 
                                            "DOR stream chemistry - compiled by Creed.xlsx"),
                                  sheet = "HP6A raw",
                                  range = "A2:G12055",
                                  col_names = DOR_chem_names)  %>% 
...
# COMBINE INTO DOR DF ----
# Times in here are messing up the joins
DOR_Q.l.j <-  DOR_Q.l %>% 
...
# EXPORT DATAFRAME ----
write_csv(DOR.f, file.path(here::here("03_generatedData/"), "01_DORcomb.csv"))
