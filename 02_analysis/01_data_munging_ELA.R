...
## ELA EIF ----
ELA.eif <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
## ELA NEIF ----
ELA.neif <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
## ELA NWIF ----
ELA.nwif <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
# codes in solute columns
    ...
    # other wise not dealing with detection limits
...
ELA.chem <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
# EXPORT DATAFRAME ----
write_csv(ELA.f, file.path(here::here("03_generatedData"), "01_ELAcomb.csv"))
