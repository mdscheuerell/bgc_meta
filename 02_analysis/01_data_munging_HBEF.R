...
# daily 
HBEF_Q <-  read_csv(file.path(here::here("01_data"), 
...
# CHEMISTRY ----
# all values are in mg/L - metadata say NH4 and NO3 concentration, not NH4-N...
...
HBEF_6_chem <-  read.csv(file.path(here::here("01_data"), 
                                 "ws6_stream_chem.csv"), na = c("", "NA")) 
HBEF_7_chem <-  read.csv(file.path(here::here("01_data"), 
                                   "ws7_stream_chem.csv"), na = c("", "NA")) 
HBEF_8_chem <-  read.csv(file.path(here::here("01_data"), 
                                   "ws8_stream_chem.csv"), na = c("", "NA")) 
HBEF_9_chem <-  read.csv(file.path(here::here("01_data"), 
...
# EXPORT DATAFRAME ----
write_csv(HBEF, file.path(here::here("03_generatedData"), "01_HBEFcomb.csv"))
