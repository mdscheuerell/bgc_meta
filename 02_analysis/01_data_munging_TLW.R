...
# had to change file type from xlsb to xlsx
# just keeping the unmanaged watersheds: 32, 35, and 38
# Q in mm


TLW_Q <-  readxl::read_xlsx(file.path(here::here("01_data"), 
...
# The read me indicates that these are mg/L/day, but they are really mg/L
C32chem <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
## 35 ----
C35chem <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
## 38 ----
C38chem <- readxl::read_xlsx(file.path(here::here("01_data"), 
...
write_csv(TLW, file.path(here::here("03_generatedData/"), "01_TLWcomb.csv"))
